/*--------------------------------------------------------------+
|  Purpose: Main include for ODBC Core functions.		|
|                                                               |
|  Date: Jan 2004                                               |
|                                                               |
|  Copyright (c) 2004                                           |
|  DataDirect Technologies Corp. All Rights Reserved.           |
|                                                               |
+--------------------------------------------------------------*/
...
/* Include Unix version of Windows-style defines and typedefs */
#include "sqlunx.h"
